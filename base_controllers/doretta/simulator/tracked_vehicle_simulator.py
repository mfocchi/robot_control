...
class TrackedVehicleSimulator:
    def __init__(self):
        ...
        self.number_of_steps = np.int32(self.sim_param.t_end / self.sim_param.dt)
    ...
    def unit_test_track(self):
        ...
        assert_almost_equal(Fx_l,  -29.4300)
        assert_almost_equal(Fy_l, 0)
        assert_almost_equal(M_long_l,8.8290)
        ...
        # print(M_long_l)
        # print(M_lat_l)
        assert_almost_equal(Fx_l,   -9.4025, decimal = 2)
        assert_almost_equal(Fy_l,  2.0778, decimal = 2)
        assert_almost_equal(M_long_l,2.6429, decimal = 2)
        assert_almost_equal(M_lat_l,   -3.0185, decimal = 2)
        #test dynamics
...
if __name__ == '__main__':
    ...
    p.traj = Trajectory(ModelsList.UNICYCLE, 0, 0, 0, DT=p.sim_param.dt, v=v, o=omega)
