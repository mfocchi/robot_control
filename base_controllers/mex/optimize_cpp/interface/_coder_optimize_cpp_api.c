  ...
  *parentId, param *y)
{
  ...
  static const char_T *fieldNames[20] = { "jump_clearance", "m",
    "obstacle_avoidance", "num_params", "int_method", "N_dyn", "FRICTION_CONE",
    "int_steps", "contact_normal", "b", "p_a1", "p_a2", "g", "w1", "w2", "w3",
    "w4", "w5", "w6", "T_th" };
  ...
  y->num_params = b_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b
    (emlrtRootTLSGlobal, u, 0, 3, "num_params")), &thisId);
  ...
  i_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 10,
    "p_a1")), &thisId, y->p_a1);
  thisId.fIdentifier = "p_a2";
  i_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 11,
    "p_a2")), &thisId, y->p_a2);
