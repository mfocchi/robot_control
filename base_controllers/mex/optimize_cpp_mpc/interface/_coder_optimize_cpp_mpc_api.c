 ...
 *
 * _coder_optimize_cpp_mpc_api.c
 *
 * Code generation for function '_coder_optimize_cpp_mpc_api'
 *
 */
...
static real_T (*c_emlrt_marshallIn(const mxArray *actual_state,
...
static int64_T i_emlrt_marshallIn(const mxArray *mpc_N,
                                  const char_T *identifier);

static int64_T j_emlrt_marshallIn(const mxArray *u,
                                  const emlrtMsgIdentifier *parentId);
...
static int64_T s_emlrt_marshallIn(const mxArray *src,
                                  const emlrtMsgIdentifier *msgId);
                               ...
                               const emlrtMsgIdentifier *parentId, param *y)
{
  ...
  static const char_T *fieldNames[11] = {
      "int_method", "int_steps", "contact_normal",
      "b",          "p_a1",      "p_a2",
      "g",          "m",         "w1",
      "w2",         "mpc_dt"};
  emlrtMsgIdentifier thisId;
  ...
  thisId.bParentIsCell = false;
  emlrtCheckStructR2012b(emlrtRootTLSGlobal, parentId, u, 11,
  ...
  y->int_steps = b_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 1, "int_steps")),
      &thisId);
  ...
  y->b = b_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 3, "b")),
      &thisId);
  thisId.fIdentifier = "p_a1";
  n_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 4, "p_a1")),
      &thisId, y->p_a1);
  thisId.fIdentifier = "p_a2";
  n_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 5, "p_a2")),
      &thisId, y->p_a2);
  thisId.fIdentifier = "g";
  y->g = b_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 6, "g")),
      &thisId);
  thisId.fIdentifier = "m";
  y->m = b_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 7, "m")),
      &thisId);
  thisId.fIdentifier = "w1";
  y->w1 = b_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 8, "w1")),
      &thisId);
  thisId.fIdentifier = "w2";
  y->w2 = b_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 9, "w2")),
      &thisId);
  thisId.fIdentifier = "mpc_dt";
  y->mpc_dt = b_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 10, "mpc_dt")),
      &thisId);
  emlrtDestroyArray(&u);
}
                          ...
                          const mxArray *plhs[3])
{
  ...
  emxInit_real_T(&x, 2);
  optimize_cpp_mpc(*actual_state, actual_t, ref_com, Fr_l0, Fr_r0, Fr_max,
                   mpc_N, &params, x, &EXITFLAG, &final_cost);
...
/* End of code generation (_coder_optimize_cpp_mpc_api.c) */
