 ...
 *
 * _coder_optimize_cpp_mpc_no_constraints_api.c
 *
 * Code generation for function '_coder_optimize_cpp_mpc_no_constraints_api'
 *
 */
...
void c_optimize_cpp_mpc_no_constrain(const mxArray * const prhs[8], int32_T nlhs,
  const mxArray *plhs[3])
{
  ...
  optimize_cpp_mpc_no_constraints(*actual_state, actual_t, ref_com, Fr_l0, Fr_r0,
...
/* End of code generation (_coder_optimize_cpp_mpc_no_constraints_api.c) */
