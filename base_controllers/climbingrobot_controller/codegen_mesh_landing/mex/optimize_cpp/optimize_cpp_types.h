...
#ifndef typedef_b_optimize_cpp_api
#define typedef_b_optimize_cpp_api
typedef struct {
  param params;
} b_optimize_cpp_api;
#endif /* typedef_b_optimize_cpp_api */

#ifndef typedef_optimize_cppStackData
#define typedef_optimize_cppStackData
typedef struct {
  b_fmincon f0;
  b_optimize_cpp_api f1;
} optimize_cppStackData;
#endif /* typedef_optimize_cppStackData */
