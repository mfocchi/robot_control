...
static const mxArray *emlrt_marshallOut(const struct0_T *u)
{
  ...
  static const char_T *sv[51] = {"path_length",
                                 ...
                                 "solution_constr",
                                 "constr_tolerance"};
  static const char_T *sv3[8] = {"p",    "psi", "l1",  "l2",
                                 "psid", "l1d", "l2d", "time"};
  ...
  lb_y = NULL;
  m = emlrtCreateDoubleScalar(u->num_constr.final_constraints);
  emlrtAssign(&lb_y, m);
  emlrtSetFieldR2017b(hb_y, 0, "final_constraints", lb_y, 3);
  mb_y = NULL;
  ...
  nb_y = NULL;
  emlrtAssign(&nb_y,
              emlrtCreateStructMatrix(1, 1, 8, (const char_T **)&sv3[0]));
  ...
  emlrtAssign(&ob_y, m);
  emlrtSetFieldR2017b(y, 0, "constr_tolerance", ob_y, 50);
  return y;
}
                               ...
                               const emlrtMsgIdentifier *parentId, param *y)
{
  ...
  static const char_T *fieldNames[24] = {"m",
                                         "num_params",
                                         "int_method",
                                         "N_dyn",
                                         "FRICTION_CONE",
  ...
  thisId.bParentIsCell = false;
  emlrtCheckStructR2012b(emlrtRootTLSGlobal, parentId, u, 24,
  ...
  y->T_th = b_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 13, "T_th")),
      &thisId);
  thisId.fIdentifier = "obstacle_avoidance";
  i_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0,
                                                    14, "obstacle_avoidance")),
                     &thisId, y->obstacle_avoidance);
  thisId.fIdentifier = "jump_clearance";
  y->jump_clearance =
      b_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(
                             emlrtRootTLSGlobal, u, 0, 15, "jump_clearance")),
                         &thisId);
  thisId.fIdentifier = "mesh_x";
  j_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 16, "mesh_x")),
      &thisId, y->mesh_x);
  thisId.fIdentifier = "mesh_y";
  j_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 17, "mesh_y")),
      &thisId, y->mesh_y);
  thisId.fIdentifier = "mesh_z";
  j_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 18, "mesh_z")),
      &thisId, y->mesh_z);
  thisId.fIdentifier = "cost_x";
  j_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 19, "cost_x")),
      &thisId, y->cost_x);
  thisId.fIdentifier = "cost_y";
  j_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 20, "cost_y")),
      &thisId, y->cost_y);
  thisId.fIdentifier = "cost_z";
  j_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 21, "cost_z")),
      &thisId, y->cost_z);
  thisId.fIdentifier = "patch_side";
  y->patch_side =
      b_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u,
                                                        0, 22, "patch_side")),
                         &thisId);
