...
inner_opt_params['patch_side'] = None
...
class BiLevelOptmizer:
    ...
    def __init__(self, terrain_manager,p0,pf):
        ...
        self.cost_grid = self.patches.get_cost_meshgrid()
        ...
        inner_opt_params['cost_x'] = self.cost_grid
        inner_opt_params['cost_y'] = self.terrain_manager.mesh_y
        inner_opt_params['cost_z'] = self.terrain_manager.mesh_z
        inner_opt_params['patch_side'] = 1.0 * self.patches.patch_width
