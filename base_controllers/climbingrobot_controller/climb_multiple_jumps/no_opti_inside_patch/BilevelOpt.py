...
class BilevelOpt:
    ...
    def eval_constraints(self, c, num_constr, constr_tolerance, debug=False, verbose = True):
        ...
        """
        safe_constr = {}
        for key in ['wall_constraints', 'retraction_force_constraints', 'force_constraints', 'final_constraints', 'via_point']:
            try:
                safe_constr[key] = int(num_constr[key])
            except (KeyError, AttributeError):
                safe_constr[key] = 0
        num_constr = safe_constr
