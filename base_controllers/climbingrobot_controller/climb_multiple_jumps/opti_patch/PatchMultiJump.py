    ...
    def execute_multi_jump_in_patch(self):
        ...
        for i in range(num_jumps):
            ...
            try:
                ...
                print(colored(f"  Jump Duration: {jump_duration:.3f} s", "green"))
                ...
                total_jump_duration += jump_duration
        ...
        print(f"Jumps: {num_jumps} | Total fitness: {total_fitness:.2f} | "
              ...
              f"Total jump duration: {total_jump_duration:.3f} s | "
        ...
        return {
            ...
            'total_jump_duration': total_jump_duration,
