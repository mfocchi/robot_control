...
void c_anon(real_T params_b, const real_T params_p_a1[3], const real_T
            ...
            real_T u1, real_T u2, real_T u4, real_T varargout_1[6])
{
  real_T b_x[9];
  real_T c_x[9];
  real_T J_tmp[3];
  ...
  t3 = c_a_tmp * c_a_tmp;
  n_par_tmp_idx_0 = a * ((n_par_tmp_idx_1 + J_tmp[0]) + u4 * (n_bar_tmp_idx_0 /
  ...
  n_par_tmp_idx_1 = a * ((n_par_tmp_idx_1 + J_tmp[1]) + u4 * (n_bar_tmp_idx_1 /
    b_y)) - (scale - b_px_tmp) / params_b;
  n_par_tmp_idx_2 = a * ((params_m * -params_g + J_tmp[2]) + u4 *
