...
if __name__ == '__main__':
    ...
    bag_name = "climbing_robot.bag"

    if not os.path.exists(bag_location+bag_name):
        print(colored("Bag File does not exists.", "red"))
    else:
        recorder.rosbagPlay(robot_name="climbingrobot", upload_args="robot_name:=climbingrobot2", bag_file=bag_location+bag_name, bag_options="-r 1")
