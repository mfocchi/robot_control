...
class Controller(BaseController):
    ...
    def gravityCompensation(self):
        ...
        #C_pinv = W_inv @ self.contact_matrix.T @ np.linalg.inv(self.contact_matrix @ W_inv @ self.contact_matrix.T)
    ...
    def estimateContacts(self):
        ...
        for legid in p.u.leg_map.keys():
            leg = p.u.leg_map[legid]
...
if __name__ == '__main__':
    p = Controller('aliengo')

    p.startupProcedure()
    q_des = conf.robot_params[p.robot_name]['q_0']
