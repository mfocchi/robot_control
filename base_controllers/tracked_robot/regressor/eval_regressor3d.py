...
model_name_beta_l = 'model_beta_l_3d_'+friction_coeff+'.cb'
model_beta_l.load_model(model_name_beta_l)

model_beta_r = cb.CatBoostRegressor()
model_name_beta_r = 'model_beta_r_3d_'+friction_coeff+'.cb'
model_beta_r.load_model(model_name_beta_r)

model_alpha = cb.CatBoostRegressor()
model_name_alpha  = 'model_alpha_3d_'+friction_coeff+'.cb'
