...
b_left_track_start = np.array([TRACK_LENGTH/2,TRACK_LENGTH/2, -0.2])
b_left_track_end = np.array([-TRACK_LENGTH/2,TRACK_LENGTH/2,  -0.2])
b_right_track_start = np.array([TRACK_LENGTH/2,-TRACK_LENGTH/2,-0.2])
b_right_track_end = np.array([-TRACK_LENGTH/2,-TRACK_LENGTH/2,-0.2])