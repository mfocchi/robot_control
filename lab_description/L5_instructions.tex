...
\noindent  
2) \textit{Projection-based controller:} 
...
\noindent9) \textit{Some experiences with the quasi-static QP controller:}
...
\noindent10) \textit{Friction cones:}
...
\noindent11) \textit{Friction cones and robustness:}
