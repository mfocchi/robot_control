...
robot_params['solo'] ={'dt': 0.004, 'kp': 5, 'kd': 0.1, 'q_0':  np.array([0.2, 0.75, -1.5, -0.2, 0.75, -1.5, 0.2, -0.75, 1.5, -0.2, -0.75, 1.5])} # note the frames are all aligned with base for joints = 0
