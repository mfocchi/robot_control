...
Inspect the \textit{simple\_geometry} file and try to understand what each line describes. How are the links described? Which parameters need to be described per link? How are joints defined? \\
...
\footnotesize
\begin{verbatim}
	roslaunch ros_impedance_controller visualize_ur4.launch test_joints:=true
\end{verbatim} 
\normalsize
