...
\begin{figure}[bht]
	...
	\caption{TODO fix sign to be consistent with lecutre, use graqdient a stoping criteria, Numerical inverse kinematics algorithm or closed-loop inverse kinematics (CLIK)}
	\label{fig:CLIK}
\end{figure}
%
