...
Therefore, in the \codeword{params.yaml} config file, set \codeword{real_robot: True},   \codeword{control_mode: point}, \codeword{control_type: position}.
...
Create a GradientBasedPlanner to control the motion of the robot (i.e. velocity set-point).
